...
function Sidebar() {
  ...
  const [isMobile, setIsMobile] = useState(window.innerWidth < 768); // Check if the initial dimension is mobile
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-30 flex flex-col w-64 px-5 py-8 overflow-y-auto bg-white border-r ${
        isMobile ? (isSidebarOpen ? 'translate-x-0' : '-translate-x-full') : 'translate-x-0'
      } transition-transform duration-300 ease-in-out transform-gpu dark:bg-gray-900 dark:border-gray-700`}
    >
      <div className="flex items-center justify-between mb-1">

        {isMobile && (
          <button
            className="focus:outline-none text-gray-600 dark:text-gray-200 hover:text-gray-700 dark:hover:text-gray-200"
      ...
      <nav className="-mx-3 space-y-6">
        <div className="space-y-3">
          <label className="px-3 text-xs text-gray-500 uppercase dark:text-gray-400">analytics</label>
           ...
           <Link to="/admin/dashboard" class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 
           transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200
            hover:text-gray-700">
          ...
          <Link to="/admin/task" class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200
           hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                    ...
                    <span class="mx-2 text-sm font-medium">Task</span>
                </Link>
            </div>
