...
export const Login = () => {
    ...
    <main class="bg-white max-w-lg mx-auto p-8 md:p-12 my-24   rounded-lg shadow-2xl">
        <section>
            <h3 class="font-bold text-2xl">Welcome to Acion Sink </h3>
        ...
        <section class="mt-10">
            <form class="flex flex-col" method="POST" action="#">
                ...
                <div class="flex justify-end">
                    <a href="#" class="text-sm text-black hover:text-black hover:underline mb-6">Forgot your password?</a>
                </div>
                <button class="bg-[#0f7383] hover:[#0f7383] text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200" type="submit">Sign In</button>
            </form>
        </section>
    </main>

    <div class="max-w-lg mx-auto text-center mt-12 mb-6 rounded-t-lg ">
